...
| N4 | **Seed the archive retroactively:** GDPNow spreadsheet + ALFRED vintages, NY Fed xlsx, ECB/Philly SPF CSVs. Schema per N1 decision: outcome rows carry publication vintage; canonical units per [09 D3](research/09-target-measure-decision.md) (q/q non-annualized, SAAR as display transform) | removes cold start; the cheapest most differentiating win; first two tracks also surface the data needed to fix D1+D2 | [06 §3](research/06-vintage-reconstruction.md) |
