...
| [tests/](tests/COVERAGE.md) | `testthat` suite (157 tests, offline, committed cache as fixtures): `Rscript tests/run_tests.R` · coverage: `Rscript tests/coverage.R` | 98.1% line coverage |
