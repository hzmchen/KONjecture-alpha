...
| [tests/](tests/COVERAGE.md) | `testthat` suite (121 tests, offline, committed cache as fixtures): `Rscript tests/run_tests.R` · coverage: `Rscript tests/coverage.R` | 97.8% line coverage |
